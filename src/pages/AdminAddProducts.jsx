...
const AdminAddProducts = () => {
  return (
    <div className={addCSS.outer_body}>
            ...
            <div className={addCSS.upload_area}>
              <div className={addCSS.upload_content}>
                ...
                <div className={addCSS.text}>
                  <p>
                    <span>drag/upload</span> your images here. <br /> Maximum of
                    5
                  </p>
                </div>
              </div>
      ...
      <div className={addCSS.third_row}>
        <div>
          <button className={addCSS.cancel_btn}>Cancel</button>
        </div>
        <div>
          <button className={addCSS.create_btn}>Create Product</button>
        </div>
      </div>
    </div>
  );
